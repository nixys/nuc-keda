...
CURRENT_MAJOR="$(printf '%s' "$CHART_VERSION" | awk -F'[.-]' '{print $1}')"
CURRENT_MINOR="$(printf '%s' "$CHART_VERSION" | awk -F'[.-]' '{print $2}')"
CURRENT_PATCH="$(printf '%s' "$CHART_VERSION" | awk -F'[.-]' '{print $3}')"
